class FocusStats {
	...
	static computeData() {
		...
		const tagsData = AppDataManager.loadObject('focus-stats', 'tags');
	...
	static setupAddTagsEvent() {
		document.getElementById('assignTags').addEventListener('click', () => {
			...
			AppDataManager.saveObject('focus-stats', 'tags', tagsData);
